	...
	morphDropdown.prototype.showDropdown = function(item) {
		...
		if( this.mq == 'desktop') {
			...
			var selectedDropdown = this.dropdownList.find('#'+item.data('content')),
					...
					selectedDropdownLeft = (item.offset().left - item.parent().offset().left) - selectedDropdownWidth/2 + item.outerWidth()/2;

			console.log( item.offset().left, item.parent().offset().left, selectedDropdownWidth, item.outerWidth());
